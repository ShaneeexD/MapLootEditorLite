...
namespace MapLootEditorLite.Client
{
    public static class Locale
    {
                ...
                private static void WriteDefaultEnglishFile(string path)
        {
            ...
            defaults["Add Component"] = "Add Component";
            defaults["Area Type"] = "Area Type";
            defaults["Back to Parent"] = "Back to Parent";
            defaults["Can Breach"] = "Can Breach";
            defaults["Category"] = "Category";
            defaults["Child not found in preview or source."] = "Child not found in preview or source.";
            defaults["Child Object"] = "Child Object";
            defaults["Click 'Scan Scene' to populate the list."] = "Click 'Scan Scene' to populate the list.";
            defaults["Close"] = "Close";
            defaults["Common"] = "Common";
            defaults["Debug"] = "Debug";
            defaults["Delete {0} marker(s)?"] = "Delete {0} marker(s)?";
            defaults["Delete Child"] = "Delete Child";
            defaults["Directional"] = "Directional";
            defaults["DoorState:"] = "DoorState:";
            defaults["Dump door IDs"] = "Dump door IDs";
            defaults["Dump keyed door IDs"] = "Dump keyed door IDs";
            defaults["Exit Editor Mode"] = "Exit Editor Mode";
            defaults["Extend Raid Timer (24h)"] = "Extend Raid Timer (24h)";
            defaults["Fallback:"] = "Fallback:";
            defaults["Filters Enabled"] = "Filters Enabled";
            defaults["Go To"] = "Go To";
            defaults["Id:"] = "Id:";
            defaults["IdEditable:"] = "IdEditable:";
            defaults["Initial Door State"] = "Initial Door State";
            defaults["Initial:"] = "Initial:";
            defaults["Interactive"] = "Interactive";
            defaults["Items"] = "Items";
            defaults["Key Id"] = "Key Id";
            defaults["KeyId:"] = "KeyId:";
            defaults["Kind"] = "Kind";
            defaults["Local Position"] = "Local Position";
            defaults["Local Rotation"] = "Local Rotation";
            defaults["Local Scale"] = "Local Scale";
            defaults["Locked"] = "Locked";
            defaults["LootableContainer"] = "LootableContainer";
            defaults["Map Loot Editor Lite - {0} ({1} markers)"] = "Map Loot Editor Lite - {0} ({1} markers)";
            defaults["Name:"] = "Name:";
            defaults["new filter keyword..."] = "new filter keyword...";
            defaults["No matching components."] = "No matching components.";
            defaults["No objects match the filter."] = "No objects match the filter.";
            defaults["Not Walkable"] = "Not Walkable";
            defaults["Object"] = "Object";
            defaults["Open"] = "Open";
            defaults["Page {0} / {1} ({2} items)"] = "Page {0} / {1} ({2} items)";
            defaults["Page {0} / {1} ({2} rows)"] = "Page {0} / {1} ({2} rows)";
            defaults["Paste"] = "Paste";
            defaults["Path:"] = "Path:";
            defaults["Pos:"] = "Pos:";
            defaults["Random Types (per bot)"] = "Random Types (per bot)";
            defaults["Rot:"] = "Rot:";
            defaults["Scale:"] = "Scale:";
            defaults["Scene Pick Filters"] = "Scene Pick Filters";
            defaults["Search..."] = "Search...";
            defaults["Showing {0} of {1} — refine filter"] = "Showing {0} of {1} — refine filter";
            defaults["Shut"] = "Shut";
            defaults["Slot"] = "Slot";
            defaults["StationaryWeapon"] = "StationaryWeapon";
            defaults["Template:"] = "Template:";
            defaults["Toggle 3D Scene Outlines"] = "Toggle 3D Scene Outlines";
            defaults["Toggle Preview Mode"] = "Toggle Preview Mode";
            defaults["Walkable"] = "Walkable";
            defaults["WorldInteractiveObject"] = "WorldInteractiveObject";
            defaults["Write Mode"] = "Write Mode";
